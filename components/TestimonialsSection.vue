    ...
    <div class="container mx-auto px-6 lg:px-8">
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="bg-primary-50 border-2 border-primary-200 p-8">
            <div class="mb-6">
              ...
              <p class="text-primary-700 leading-relaxed italic mb-6">
                "Редко встречаешь ведущего, который действительно понимает
                технический контент. Он не просто читал сценарий — он вёл
                диалог, задавал правильные вопросы, помогал аудитории глубже
          ...
          <!-- Отзыв 4 -->
          <div class="bg-primary-900 text-white border-2 border-primary-900 p-8">
            <div class="mb-6">
              <div class="flex gap-1 mb-4">
              ...
              <p class="text-primary-200 leading-relaxed italic mb-6">
                ...
                техническая экспертиза позволила ему не просто вести мероприятие,
