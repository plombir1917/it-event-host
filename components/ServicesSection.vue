      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          >
            ...
            <p class="text-primary-200 leading-relaxed mb-6">
              Энергичное ведение форумов, поддержка участников, технические
          ...
          >
            ...
            <p class="text-primary-200 leading-relaxed mb-6">
              Внутренние корпоративы, награждения, тимбилдинги, годовщины
              организаций. Понимание корпоративной культуры и технического
              контекста.
            </p>
            <ul class="space-y-2 text-sm text-primary-300">
              <li>• Торжественные открытия</li>
              <li>• Внутренние награждения</li>
              <li>• Тимбилдинги</li>
